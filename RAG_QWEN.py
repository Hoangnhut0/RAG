...
# 🔹 Hàm gọi API Ollama với Qwen2.5 3B
def call_ollama(prompt, model="qwen2.5:3b"):  # Thay "deepseek-r1" bằng "qwen2.5:3b"
...
def correct_spelling_with_ollama(text):
    prompt = f"""
    Văn bản sau có thể chứa lỗi chính tả tiếng Việt do trích xuất từ OCR.
    Chỉ sửa lỗi chính tả không giải thích gì thêm.
...
# 🤖 Xử lý với Ollama Qwen2.5 3B (Phần trả lời chính từ Ollama)
